...
/*
 * This implementation is a port from TCP-Illinois of the linux kernel,
 * available here: http://lxr.free-electrons.com/source/net/ipv4/tcp_illinois.c
 * The relevant paper describing the algorithm can be found at
 * http://citeseerx.ist.psu.edu/viewdoc/summary?doi=10.1.1.296.6350
 */
